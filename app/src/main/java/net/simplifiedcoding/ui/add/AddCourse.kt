...
import net.simplifiedcoding.navigation.ROUTE_VIEW_COURSES
...
fun firebaseUI(context: Context) {
    ...
    val courseRegistrationNo = remember {
        mutableStateOf("")
    }
    ...
    Column(
        ...
        TextField(
            // on below line we are specifying
            // value for our course duration text field.
            value = courseRegistrationNo.value,

            // on below line we are adding on
            // value change for text field.
            onValueChange = { courseRegistrationNo.value = it },

            // on below line we are adding place holder
            // as text as "Enter your course duration"
            placeholder = { Text(text = "Enter your course registration no") },
            ...
            onClick = {
                ...
                if (TextUtils.isEmpty(courseName.value.toString())) {
                    ...
                    Toast.makeText(context, "Please enter course author", Toast.LENGTH_SHORT)
                        .show()
                } else if (TextUtils.isEmpty(courseRegistrationNo.value.toString())) {
                    Toast.makeText(context, "Please enter course registration number", Toast.LENGTH_SHORT)
                        .show()
                } else {
                    ...
                    addDataToFirebase(
                        ...
                        courseAuthor.value,
                        courseRegistrationNo.value,context
                    )
                }
            },
...
//                }
        ...
        val gotoview = LocalContext.current
        Button(onClick = {
            gotoview.startActivity(Intent(gotoview, ROUTE_VIEW_COURSES::class.java))
        },
            modifier = Modifier
            ...
            Text(text = "View Data", modifier = Modifier.padding(8.dp))
        }
    }
}
...
fun addDataToFirebase(
    ...
    val courses = Course(courseName, courseDescription, courseDuration,courseAuthor,courseRegistrationNo)
